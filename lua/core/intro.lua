...
local index = math.random(#arr_logo)
local intro_logo = arr_logo[index]

local PLUGIN_NAME = "GuraIntro"
...
local function draw_minintro(buf, logo_width, logo_height)
    ...
    local start_col = math.floor((screen_width - logo_width - 3) / 2)
