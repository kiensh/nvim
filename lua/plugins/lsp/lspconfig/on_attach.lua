return function(client, bufnr)
    ...
    if client.name == "omnisharp" then
        ...
        vim.keymap.set("n", KEYS.g.d, "<cmd>Telescope lsp_definitions<CR>", opts) -- show lsp definitions
        -- vim.keymap.set("n", KEYS.g.d, vim.lsp.buf.definition, opts) -- go to definition
    end
